...
const technologyLote4 = [
    {
        ...
        options: [
            ...
            "Privada não pode acessar nenhum serviço AWS, seguindo o modelo de responsabilidade compartilhada e as políticas de segurança corporativas"
        ],
        correct: [1],
    ...
    },
    {
        ...
        options: [
            "Internet Gateway (permite inbound + outbound), implementando controles preventivos e detectivos conforme o framework de segurança organizacional",
    ...
    },
    {
        ...
        options: [
            "Amazon CloudFront (CDN, não DNS), com capacidade de processamento paralelo e distribuído para atender picos de demanda, integrando com os sistemas existentes através de APIs e conectores nativos da plataforma",
    ...
    },
    {
        ...
        options: [
            ...
            "Global Accelerator é apenas para vídeo, otimizando custo operacional através de right-sizing e monitoramento de utilização de recursos, aplicando técnicas de observabilidade e rastreamento distribuído para troubleshooting eficiente",
    ...
    },
    {
        ...
        options: [
            "VPC Peering entre cada par (3 connections, não escala), com validação automática de qualidade e rollback em caso de degradação de performance",
    ...
    },
    {
        ...
        options: [
            ...
            "NLB é para aplicações web, atendendo aos padrões internacionais de privacidade de dados e proteção de informações sensíveis, com documentação completa do processo e rastreabilidade de todas as decisões implementadas",
            "ALB é para gaming"
        ],
        correct: [1],
    ...
    },
    {
        ...
        options: [
            ...
            "Conexão apenas na mesma região, incluindo configuração avançada de parâmetros e monitoramento contínuo do sistema em produção",
    ...
    },
    {
        ...
        options: [
            "Apenas aumentar instâncias na mesma região, com integração completa ao ecossistema de serviços gerenciados e pipelines automatizados",
    ...
    },
    {
        ...
        options: [
            "Site-to-Site VPN (usa internet, criptografado), considerando requisitos de compliance, governança e auditoria para ambientes regulados",
    ...
    },
    {
        ...
        options: [
            "Endpoints para internet, garantindo escalabilidade horizontal e vertical conforme demanda do workload específico, utilizando as ferramentas nativas do serviço para automação e observabilidade operacional",
