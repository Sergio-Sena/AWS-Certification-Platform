...
const securityLote5 = [
    {
        ...
        options: [
            ...
            "AWS — responsável por toda infraestrutura",
    ...
    },
    {
        ...
        options: [
            "AWS Cognito (autenticação para apps web/mobile)",
    ...
    },
    {
        ...
        options: [
            ...
            "NACL deny",
            "Security Group bloqueando serviços",
    ...
    },
    {
        ...
        options: [
            ...
            "Configurar WAF manualmente em cada conta",
            "AWS Config",
    ...
    },
    {
        ...
        options: [
            "São o mesmo serviço",
            "Inspector detecta ameaças, GuardDuty escaneia vulnerabilidades",
    ...
    },
    {
        ...
        options: [
            ...
            "Depende da ordem",
            "A policy mais recente prevalece"
        ],
        correct: [1],
    ...
    },
    {
        ...
        options: [
            ...
            "Apenas ativar encryption default no bucket",
