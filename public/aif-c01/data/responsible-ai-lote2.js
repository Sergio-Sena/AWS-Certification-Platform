...
const responsibleAiQuestions2 = [
    {
        ...
        options: [
            ...
            "CloudWatch Logs",
            "AWS Config",
            "Amazon Inspector dentro do escopo de aplicação apresentado"
        ],
        correct: [0],
    ...
    },
    {
        ...
        options: [
            "Mostrar código-fonte do modelo segundo as diretrizes oficiais e compliance",
    ...
    },
    {
        ...
        options: [
            "Cartão de crédito para pagar AWS como abordagem principal neste caso de uso",
    ...
    },
    {
        ...
        options: [
            ...
            "Treinar modelo separado por gênero para garantir conformidade com os requisitos"
        ],
        correct: [1],
    ...
    },
    {
        ...
        options: [
            ...
            "Variáveis intermediárias no modelo na arquitetura proposta para o ambiente",
            "Features de cache"
        ],
        correct: [0],
    ...
    },
    {
        ...
        options: [
            "Humano gerencia infraestrutura em cenários empresariais de produção real",
    ...
    },
    {
        ...
        options: [
            "Cartões de pagamento de serviços AI seguindo o framework de implementação padrão",
            "Métricas de billing",
    ...
    },
    {
        ...
        options: [
            "Confiar no treinamento do modelo como solução adequada ao problema descrito",
    ...
    },
    {
        ...
        options: [
            ...
            "Direito de treinar seu próprio modelo atendendo aos critérios de avaliação definidos"
        ],
        correct: [0],
    ...
    },
    {
        ...
        options: [
            "Todos usam o mesmo modelo no contexto operacional da organização",
    ...
    },
    {
        ...
        options: [
            "CloudWatch apenas para assegurar resultados consistentes e confiáveis",
            "GuardDuty",
            "AWS Config",
    ...
    },
    {
        ...
        options: [
            "Parentesco entre datasets para este tipo de cenário e workload específico",
    ...
    },
    {
        ...
        options: [
            ...
            "Apenas performance conforme recomendado pela documentação técnica",
            "Apenas custo",
            "Apenas velocidade"
        ],
        correct: [0],
    ...
    },
    {
        ...
        options: [
            "Apenas aceitar termos de uso da AWS considerando o contexto descrito na questão",
    ...
    },
    {
        ...
        options: [
            ...
            "Apenas custo e performance de acordo com as melhores práticas do setor",
    ...
    },
    {
        ...
        options: [
            "Competição entre empresas dentro do escopo de aplicação apresentado",
    ...
    },
    {
        ...
        options: [
            ...
            "Deletar dados pessoais do modelo segundo as diretrizes oficiais e compliance",
    ...
    },
    {
        ...
        options: [
            "Nenhum — dados históricos são neutros como abordagem principal neste caso de uso",
    ...
    },
    {
        ...
        options: [
            ...
            "Responsabilidade é sempre da AWS para garantir conformidade com os requisitos",
    ...
    },
    {
        ...
        options: [
            "Modelo fisicamente resistente na arquitetura proposta para o ambiente",
    ...
    },
    {
        ...
        options: [
            ...
            "Apenas treinamento de equipe em cenários empresariais de produção real"
        ],
        correct: [0],
    ...
    },
    {
        ...
        options: [
            "Impacto em performance do servidor seguindo o framework de implementação padrão",
            "Impacto de latência",
    ...
    },
    {
        ...
        options: [
            "São a mesma coisa",
            "Explicável é mais barato como solução adequada ao problema descrito",
    ...
    },
    {
        ...
        options: [
            "Segurança de rede atendendo aos critérios de avaliação definidos",
    ...
    },
    {
        ...
        options: [
            ...
            "Cliente é responsável por tudo no contexto operacional da organização",
    ...
    },
    {
        ...
        options: [
            "Todos os projetos têm o mesmo risco para assegurar resultados consistentes e confiáveis",
            "Apenas por custo",
    ...
    },
    {
        ...
        options: [
            ...
            "Consentimento implícito é suficiente para este tipo de cenário e workload específico",
    ...
    },
    {
        ...
        options: [
            ...
            "Usar energia solar no data center conforme recomendado pela documentação técnica"
        ],
        correct: [1],
    ...
    },
    {
        ...
        options: [
            ...
            "Ignorar — reflete a realidade dos dados considerando o contexto descrito na questão",
