...
const foundationModelsQuestions5 = [
    {
        ...
        options: [
            ...
            "Copiar o modelo manualmente entre regiões como solução adequada ao problema descrito",
    ...
    },
    {
        ...
        options: [
            ...
            "Usar apenas Kendra",
            "Fine-tuning com citações no contexto operacional da organização",
    ...
    },
    {
        ...
        options: [
            "Throughput gratuito para todos para assegurar resultados consistentes e confiáveis",
    ...
    },
    {
        ...
        options: [
            ...
            "Confiar no modelo — modelos modernos não alucinam para este tipo de cenário e workload específico",
    ...
    },
    {
        ...
        options: [
            "Invocar modelo 100.000 vezes em sequência conforme recomendado pela documentação técnica",
    ...
    },
    {
        ...
        options: [
            "Dados sintéticos são sempre perfeitos considerando o contexto descrito na questão",
    ...
    },
    {
        ...
        options: [
            "São exatamente a mesma coisa de acordo com as melhores práticas do setor",
    ...
    },
    {
        ...
        options: [
            ...
            "Sempre buscar — RAG em toda pergunta dentro do escopo de aplicação apresentado",
            "Nunca buscar",
    ...
    },
    {
        ...
        options: [
            "Deixar o modelo responder tudo segundo as diretrizes oficiais e compliance",
    ...
    },
    {
        ...
        options: [
            ...
            "Dashboard de custos",
            "Ferramenta de monitoramento como abordagem principal neste caso de uso",
    ...
    },
    {
        ...
        options: [
            ...
            "Bedrock é sempre mais rápido para garantir conformidade com os requisitos"
        ],
        correct: [1],
