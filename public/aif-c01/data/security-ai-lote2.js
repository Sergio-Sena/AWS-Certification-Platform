...
const securityAiQuestions2 = [
    {
        ...
        options: [
            ...
            "Todos os dados são usados para melhorar modelos conforme recomendado pela documentação técnica",
    ...
    },
    {
        ...
        options: [
            "Não é possível — Bedrock é serviço público considerando o contexto descrito na questão",
            "VPN obrigatória",
    ...
    },
    {
        ...
        options: [
            ...
            "Remover acesso ao Bedrock inteiro de acordo com as melhores práticas do setor",
    ...
    },
    {
        ...
        options: [
            ...
            "Modelo fica com o provider (Anthropic, Meta) dentro do escopo de aplicação apresentado",
    ...
    },
    {
        ...
        options: [
            ...
            "CloudWatch apenas segundo as diretrizes oficiais e compliance",
            "AWS Config",
            "Amazon Inspector"
        ],
        correct: [0],
    ...
    },
    {
        ...
        options: [
            "CloudTrail registra automaticamente como abordagem principal neste caso de uso",
            "Não é possível",
    ...
    },
    {
        ...
        options: [
            "Apenas criptografia do modelo para garantir conformidade com os requisitos",
            "Apenas KMS",
            "Apenas TLS",
    ...
    },
    {
        ...
        options: [
            "Erro de formatação inofensivo na arquitetura proposta para o ambiente",
    ...
    },
    {
        ...
        options: [
            ...
            "Senha no modelo",
            "Firewall na aplicação em cenários empresariais de produção real",
            "API key no código"
        ],
        correct: [0],
    ...
    },
    {
        ...
        options: [
            "Modelo com vírus de computador seguindo o framework de implementação padrão",
    ...
    },
    {
        ...
        options: [
            ...
            "Documentos não precisam de proteção como solução adequada ao problema descrito",
    ...
    },
    {
        ...
        options: [
            "Nenhum — Bedrock não é para saúde atendendo aos critérios de avaliação definidos",
    ...
    },
    {
        ...
        options: [
            ...
            "Modelos não memorizam dados no contexto operacional da organização",
    ...
    },
    {
        ...
        options: [
            "Onde os desenvolvedores moram para assegurar resultados consistentes e confiáveis",
    ...
    },
    {
        ...
        options: [
            "Dar acesso Admin para todos para este tipo de cenário e workload específico",
    ...
    },
    {
        ...
        options: [
            "Apenas filtros de conteúdo conforme recomendado pela documentação técnica",
    ...
    },
    {
        ...
        options: [
            ...
            "Modelos não podem ser roubados considerando o contexto descrito na questão",
    ...
    },
    {
        ...
        options: [
            ...
            "Lei internacional sem efeito local de acordo com as melhores práticas do setor",
    ...
    },
    {
        ...
        options: [
            "Apenas verificar billing no fim do mês dentro do escopo de aplicação apresentado",
    ...
    },
    {
        ...
        options: [
            ...
            "Cadeia de suprimentos de GPUs segundo as diretrizes oficiais e compliance",
    ...
    },
    {
        ...
        options: [
            ...
            "Criptografia manual antes do upload como abordagem principal neste caso de uso"
        ],
        correct: [0],
    ...
    },
    {
        ...
        options: [
            ...
            "Apenas controle de acesso para garantir conformidade com os requisitos"
        ],
        correct: [2],
    ...
    },
    {
        ...
        options: [
            "Confiar que desenvolvedores usem HTTPS na arquitetura proposta para o ambiente",
            "Usar VPN apenas",
    ...
    },
    {
        ...
        options: [
            "Privacidade de dados entre departamentos em cenários empresariais de produção real",
    ...
    },
    {
        ...
        options: [
            ...
            "Usar menos dados possível para economizar seguindo o framework de implementação padrão",
            "Comprimir dados",
    ...
    },
    {
        ...
        options: [
            ...
            "Gerenciador de endpoints como solução adequada ao problema descrito"
        ],
        correct: [2],
    ...
    },
    {
        ...
        options: [
            ...
            "Apenas documentar política atendendo aos critérios de avaliação definidos",
    ...
    },
    {
        ...
        options: [
            ...
            "Apenas criptografia",
            "Apenas monitoramento no contexto operacional da organização"
        ],
        correct: [1],
