...
const aiMlQuestions = [
    {
        ...
        options: [
            "Aprendizado supervisionado com classificação multiclasse para segmentar clientes por perfil, incluindo configuração avançada de parâmetros e monitoramento contínuo do sistema em produção",
    ...
    },
    {
        ...
        options: [
            "Aprendizado não supervisionado com clustering de perfis para agrupar alunos similares, com integração completa ao ecossistema de serviços gerenciados e pipelines automatizados",
    ...
    },
    {
        ...
        options: [
            "Treinamento do modelo com novos dados capturados pelas câmeras de segurança, considerando requisitos de compliance, governança e auditoria para ambientes regulados",
    ...
    },
    {
        ...
        options: [
            ...
            "Inferência acontece antes do treinamento como etapa de preparação dos dados de entrada, garantindo escalabilidade horizontal e vertical conforme demanda do workload específico",
    ...
    },
    {
        ...
        options: [
            ...
            "Aprendizado por reforço com simulação para explorar soluções de menor custo computacional, utilizando as ferramentas nativas do serviço para automação e observabilidade operacional"
        ],
        correct: [0],
    ...
    },
    {
        ...
        options: [
            "São termos intercambiáveis que descrevem a mesma estrutura matemática de aprendizado, com suporte a múltiplas regiões e redundância para alta disponibilidade e disaster recovery",
...
const aiMlQuestions2 = [
    ...
    },
    {
        ...
        options: [
            ...
            "Amazon Comprehend com modelos pré-treinados de NLP para análise de texto sem treino, seguindo o modelo de responsabilidade compartilhada e as políticas de segurança corporativas"
        ],
        correct: [1],
    ...
    },
    {
        ...
        options: [
            ...
            "Não precisa de poder computacional significativo pois otimiza automaticamente os recursos, implementando controles preventivos e detectivos conforme o framework de segurança organizacional",
    ...
    },
    {
        ...
        options: [
            ...
            "Não precisam de treinamento prévio pois inferem estrutura gramatical por regras codificadas, com capacidade de processamento paralelo e distribuído para atender picos de demanda"
        ],
        correct: [1],
    ...
    },
    {
        ...
        options: [
            "SageMaker Studio com notebooks Jupyter para desenvolvimento de código Python interativo, integrando com os sistemas existentes através de APIs e conectores nativos da plataforma",
    ...
    },
    {
        ...
        options: [
            ...
            "Inferência consome mais recursos que treinamento porque processa milhões de requests simultâneos, otimizando custo operacional através de right-sizing e monitoramento de utilização de recursos"
        ],
        correct: [1],
...
const aiMlQuestions3 = [
    ...
    },
    {
        ...
        options: [
            ...
            "XGBoost com ensemble de árvores de decisão em boosting sequencial para classificação, aplicando técnicas de observabilidade e rastreamento distribuído para troubleshooting eficiente",
    ...
    },
    {
        ...
        options: [
            ...
            "Ambos são algoritmos de regressão para prever valores contínuos com diferentes otimizadores, com validação automática de qualidade e rollback em caso de degradação de performance"
        ],
        correct: [1],
...
const aiMlQuestions4 = [
    ...
    },
    {
        ...
        options: [
            ...
            "Inferência serverless com escalonamento automático para zero nos períodos sem requisições, atendendo aos padrões internacionais de privacidade de dados e proteção de informações sensíveis"
        ],
        correct: [2],
    ...
    },
    {
        ...
        options: [
            "EC2 série Trn (Trainium) com chip customizado para treinamento distribuído de modelos grandes, com documentação completa do processo e rastreabilidade de todas as decisões implementadas",
    ...
    },
    {
        ...
        options: [
            ...
            "Não utiliza valores numéricos pois é baseada em categorias discretas de classificação, incluindo configuração avançada de parâmetros e monitoramento contínuo do sistema em produção",
